...
view model =
  ...
  [
    ...
    --}
    div [] [text "Zon: ", meter [ Html.Attributes.min "0", Html.Attributes.max "3800", Html.Attributes.value (toString (10 * (statusByName "LichtScreen" model.statuses).level)) ] [], text ((toString (round (toFloat (statusByName "LichtScreen" model.statuses).level/365.0*100)))++"%") ],
    div [] [text "Wind: ", meter [ Html.Attributes.min "0", Html.Attributes.max "8.5", Html.Attributes.value (toString (statusByName "Windmeter" model.statuses).level) ] [], text (toString (statusByName "Windmeter" model.statuses).level) ],
